...
export default function ProgressBar(){
    ...
    useEffect(() => {
      const handleScroll = (e) => {
        ...
        setShowScrollToTop(winScroll > window.innerHeight)    
    ...
    return (
        <>
            <hr className={s.progress__bar} style={{width : `${scrollBar}%`}} />

         
            <button className={`${s.to__top} ${showScrollToTop ? s.showTopBtn : ''}` }>
